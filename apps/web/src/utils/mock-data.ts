...
export const MOCK_LISTINGS: Listing[] = [
  ...
  },
  {
    id: 'l2',
    storeId: 's2',
    storeName: 'Sole Republic',
    storeHandle: 'SoleRepublic',
    title: 'Supreme Box Logo Tee',
    category: 'Clothes',
    subcategory: 'Tops',
    condition: 'BNWT',
    size: 'L',
    measurements: { chest: 56, length: 72 },
    price: 6500,
    negotiable: false,
  ...
  },
  {
    ...
    storeName: 'Thrift By Kath',
    storeHandle: 'ThriftByKath',
    title: 'Jordan 1 Retro High Chicago',
    category: 'Shoes',
    subcategory: 'Sneakers',
    condition: '9/10',
    size: '9.5',
    sizeUnit: 'US',
    measurements: { insoleLength: 27.5 },
    price: 12000,
    negotiable: true,
  ...
  },
  {
    ...
    condition: '8/10',
    size: 'M',
    measurements: { chest: 54, length: 68 },
    price: 8500,
    negotiable: true,
  ...
  },
  {
    ...
    storeName: 'Thrift By Kath',
    storeHandle: 'ThriftByKath',
    title: 'Vintage Band Tee — Metallica',
    category: 'Clothes',
    subcategory: 'Tops',
    condition: 'Thrifted',
    size: 'XL',
    measurements: { chest: 60, length: 76 },
    price: 1200,
    negotiable: true,
  ...
  },
  {
    ...
    storeName: 'Sole Republic',
    storeHandle: 'SoleRepublic',
    title: 'Levis 501 Original Fit',
    category: 'Clothes',
    subcategory: 'Bottoms',
    condition: '7/10',
    size: '32',
    measurements: { waist: 82, inseam: 80, length: 105 },
    price: 1800,
    negotiable: true,
    shippingOptions: ['J&T Express', 'Lalamove'],
  ...
  },
  {
    ...
    condition: 'Thrifted',
    size: 'L',
    measurements: { chest: 58, length: 70 },
    price: 950,
    negotiable: true,
    shippingOptions: ['J&T Express'],
  ...
  },
  {
    ...
    condition: 'VNDS',
    size: 'M',
    measurements: { waist: 78, inseam: 74, length: 100 },
    price: 2200,
    negotiable: false,
    shippingOptions: ['LBC', 'Lalamove'],
...
export const MOCK_CONVERSATIONS: Conversation[] = [
  {
    id: 'c1',
    listingId: 'l1',
    listingTitle: 'Vintage Nike Air Max 97',
  ...
  },
  {
    id: 'c2',
    listingId: 'l3',
    listingTitle: 'Jordan 1 Retro High Chicago',
    listingPhoto: '/assets/products/jordan1chicago.jpg',
    listingPrice: 12000,
    buyerId: 'u4',
    buyerName: 'Jessa Reyes',
    sellerId: 'u1',
    sellerName: 'Kath',
    lastMessage: 'Can you do ₱10,000?',
    lastMessageAt: '2026-04-04T12:00:00Z',
    unreadCount: 0,
  },
]
...
export const MOCK_MESSAGES: Message[] = [
  ...
  },
  {
    ...
    senderId: 'u3',
    senderName: 'Miguel Santos',
    content: 'Can I get more photos of the sole?',
    createdAt: '2026-04-04T14:35:00Z',
  },
  {
    id: 'm4',
    conversationId: 'c2',
    senderId: 'u4',
    senderName: 'Jessa Reyes',
    content: 'Interested in the Chicagos!',
  ...
  },
  {
    ...
    senderId: 'u1',
    senderName: 'Kath',
    content: 'Great taste! What size are you?',
...
export const MOCK_NOTIFICATIONS: Notification[] = [
  {
    ...
    type: 'new_offer',
    title: 'New Offer',
    body: 'Miguel Santos offered ₱4,000 for Vintage Nike Air Max 97',
    linkTo: '/messages',
    read: false,
  ...
  },
  {
    ...
    type: 'new_comment',
    title: 'New Comment',
    body: 'Jessa commented on Jordan 1 Chicago',
    linkTo: '/listing/l3',
    read: false,
  ...
  },
  {
    ...
    title: 'New Drip',
    body: 'Sole Republic just dropped Nike Tech Fleece Joggers',
    linkTo: '/listing/l8',
    read: true,
  ...
  },
  {
    ...
    title: 'Reserved',
    body: 'Your reservation for Jordan 1 Chicago has been confirmed',
    linkTo: '/listing/l3',
    read: true,
