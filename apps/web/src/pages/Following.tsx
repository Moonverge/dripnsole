    ...
    <div className="mx-auto max-w-[1280px] px-4 py-6">
      ...
      {isLoading ? (
        ...
        <div className="flex min-h-[40vh] flex-col items-center justify-center">
          ...
          <p className="font-martian text-sm text-text-muted">No new drops from stores you follow</p>
          <p className="mt-1 font-martian text-xs text-text-faint">Follow stores to see their latest listings here</p>
        </div>
      ) : (
