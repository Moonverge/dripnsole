    ...
    <div>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4 font-martian text-sm text-text-muted">
          Connect your Facebook Page and Instagram Business account to cross-post listings.
        </p>
          ...
          <div className="flex items-center justify-between rounded-xl border border-border p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                {fbConnection?.connected ? (
                  <p className="font-martian text-xs text-accent-green">
                    {fbConnection.accountName} · Connected
                  </p>
                ) : (
            ...
            {fbConnection?.connected ? (
              <button
                ...
                className="cursor-pointer rounded-full border border-accent-red px-4 py-2 font-martian text-xs text-accent-red transition-colors hover:bg-red-50"
              >
                Disconnect
              </button>
            ) : (
              <button
                ...
                className="cursor-pointer rounded-full bg-[#1877F2] px-4 py-2 font-martian text-xs text-white transition-colors hover:bg-[#1565C0] disabled:opacity-50"
              >
          ...
          <div className="flex items-center justify-between rounded-xl border border-border p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                {igConnection?.connected ? (
                  <p className="font-martian text-xs text-accent-green">
                    {igConnection.accountName} · Connected
                  </p>
                ) : (
                  <p className="font-martian text-xs text-text-muted">Not connected</p>
                )}
            ...
            {igConnection?.connected ? (
              ...
              <button
                ...
                className="cursor-pointer rounded-full bg-[#E4405F] px-4 py-2 font-martian text-xs text-white transition-colors hover:bg-[#D32F52] disabled:opacity-50"
              >
